...
function loadUserSettings()
{
	...
	if ($id_member != 0)
	{
		//nwsw hook to handle any member upgrades...during upgrade, this function might not be loaded
		if (function_exists('nw_elk_load_user')) nw_elk_load_user($id_member);
